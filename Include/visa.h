...
/* 使用NI-VISA扩展时，必须与NI-VISA随附的VISA库链接。 目前，NI-VISA提供的扩展是：*/
/*                                                                           */
...
/* PXI（用于仪器的紧凑型PCI扩展）和PCI支持。 要使用它，必须在包含此头文件之前     */
/* 定义宏NIVISA_PXI。 您还必须使用VISA驱动程序开发向导创建INF文件。              */
/*                                                                           */
...
/* viPeekXX / viPokeXX的一组快速宏，可以保证与VISA的其他实现的二进制兼容性。     */
/* 要使用它，必须在包含此头文件之前定义宏NIVISA_PEEKPOKE。                      */
/*                                                                           */
...
/* You must also create an INF file with the VISA Driver Development Wizard. */
/* 支持不符合特定类别的USB设备。 要使用此功能，必须在包含此头之前定义宏NIVISA_USB。*/ 
/* 您还必须使用VISA驱动程序开发向导创建INF文件。                                */
/*---------------------------------------------------------------------------*/
